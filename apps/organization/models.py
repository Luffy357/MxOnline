...
class CityDict(models.Model):
    ...
    add_time = models.DateField(default=datetime.now, verbose_name=u'时间')
...
class CourseOrg(models.Model):
    ...
    tag = models.CharField(default=u'全国知名', max_length=10, verbose_name=u'课程名称')
    catgory = models.CharField(verbose_name=u'机构类别', max_length=20, choices=(('pxjg', '培训机构'), ('gr', '个人'), ('gx', '高校')))
